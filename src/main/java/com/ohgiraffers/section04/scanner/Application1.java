...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        /* 목차 2-4. 논리형 값 입력 받기 */
        /* nextBoolean() : 입력받은 값을 bloolean 형으로 반환한다. */
        System.out.print("참과 거짓 중에 한 가지를 true or false로 입력해주세요 : ");
        boolean isTrue = sc.nextBoolean();
        System.out.println("입력하신 논리 값은 " + isTrue + "입니다.");

        /* 목차 2-5. 문자형 값 입력받기 */
//        charAt(0) => 나중에 배열에서 배움, 괄호 안에 들어가는 값을 index라 함, index는 0부터 시작함. 0번째 index는 첫번째 라고 생각하면 됨.
        sc.nextLine();      // 위에 논리값 입력한 후 버퍼에 (\n)라는 데이터가 남아있으므로 지워줘야 함.
